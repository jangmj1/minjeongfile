...
<body>
	...
	<%
		//jsp 이용한 서블릿 대체(서블릿 없을때)
		Dao dao=new Dao();
		int custno=dao.getcutno();
	...
	<center>홈쇼핑 회원 등록
		<form name="joinform" action="/hrd_exam1/join" method="post">
			<table border="1">
				<tr>
					<td>회원번호(자동발생)</td><td><input value="<%=custno%>" name="custno" type="text"></td>
				</tr>
				<tr>
					<td>회원성명</td><td><input name="custname" type="text"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>가입일자</td><td><input value="<%=now%>" name="joindate" type="text"></td>
				</tr>
				<tr>
	...
	<script src="/hrd_exam1/js/join.js" type="text/javascript"></script>
</body>
</html>